...
<section class="relative my-6 overflow-hidden rounded-2xl border border-border bg-card px-8 py-10 sm:my-10 sm:px-12 sm:py-14">
	...
	<img src={logo} alt="" aria-hidden="true" class="pointer-events-none select-none absolute top-20 -right-20 sm:-top-7 sm:-right-18 z-0 h-136 opacity-20 dark:opacity-10 [mask-image:linear-gradient(to_right,transparent,black_35%)]" />
